...
if __name__ == "__main__":
    ...
    print(requests.get("http://192.168.0.10/switch_cameramode.cgi?mode=rec&lvqty=08000x0600", headers=headers).text)
    ...
    print(requests.get("http://192.168.0.10/exec_takemisc.cgi?com=changelvqty&lvqty=0800x0600", headers=headers).text)
